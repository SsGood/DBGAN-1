...
flags.DEFINE_integer('hidden1', 64, 'Number of units in hidden layer 1.')#for citeseer 64
flags.DEFINE_integer('hidden2', 128, 'Number of units in hidden layer 2.')#for citeseer 64
...
'''
We set a seed here to steadily reveal better performance
'''
seed = 7
np.random.seed(seed)
